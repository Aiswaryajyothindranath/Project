  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
       ...
       <!--   <form id="quickForm" method="post" action="<?= base_url() ?>index.php/welcome/discount_submit">
          <div class="card-body">
            <div class="row">
              ...
              <div class="col-md-6">
                ...
                <div class="form-group">
                  ...
                  <select name="discount_mode" class="form-control select2" style="width: 100%;">
                    <option selected="selected" value="">Select a discount mode</option>
               ...
               <div class="col-md-6">
                <div class="form-group">
                  <label>Value </label>
                 <input type="text" name="value" class="form-control" id="value" placeholder="Enter valuee">
                </div>
              ...
              <tbody>
                  ...
                  <tr>
                    <td>
                      ...
                      <td>
                          <?php echo $discount['discount_mode']; ?>
                      </td>
                      <td>
                          <a>
                       ...
                       <td>
                          <?php echo $discount['tax']; ?>
                      </td>
                      <td class="project-actions text-right">
                          <a class="btn btn-primary btn-sm" href="<?php echo base_url('index.php/welcome/edit_discount/'.$discount['id']) ?>">
