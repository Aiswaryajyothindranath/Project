...
<head>
  ...
  <title>Product Invoice | Dashboard</title>
...
<!-- Bootstrap 4 -->
<script src="<?php echo base_url();?>assets/plugins/bootstrapassets/js/bootstrap.bundle.min.js"></script>
<!-- ChartJS -->
...
<!-- Tempusdominus Bootstrap 4 -->
<script src="<?php echo base_url();?>assets/plugins/tempusdominus-bootstrap-4assets/js/tempusdominus-bootstrap-4.min.js"></script>
<!-- Summernote -->
<script src="<?php echo base_url();?>assets/plugins/summernote/summernote-bs4.min.js"></script>
<!-- overlayScrollbars -->
<script src="<?php echo base_url();?>assets/plugins/overlayScrollbarsassets/js/jquery.overlayScrollbars.min.js"></script>
<!-- AdminLTE App -->
